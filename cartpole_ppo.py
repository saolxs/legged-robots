...
def update_ppo(envs, args, agent):
    ...
    for batch_states, batch_logprobs, batch_actions, batch_advantages, batch_returns, batch_values in get_batches(envs, args, optimizer, agent, device):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                _, newlogprob, entropy, newvalue = agent.get_action_value(batch_states[minibatch_inds], batch_actions.long()[minibatch_inds])
